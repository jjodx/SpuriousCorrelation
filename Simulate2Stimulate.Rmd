...
2. use parallel loops such as in http://datacolada.org/102 -> tested but seems to give different results
4. update citations, anything since 2019? (Makin, Corneille, etc.)
-->
