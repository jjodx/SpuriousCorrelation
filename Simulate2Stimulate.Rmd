...
5) When power is low, the overestimation of effect size because of publication bias is large, the with of the CI of the indivdiual correlation coefficient is large, the uncertainty of around the correlation coefficient is large, the effect of irregularities in the data (outliers or subgroups) is also prominent [@button2013].
