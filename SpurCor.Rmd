...
Nsim=100 # number of generated samples; should be 10000
Rval=0 # correlation coeffecient in the absence of effect
Rval50=0.5 # correlation coefficient when there is an effect
```
...
# drawing random numbers for the variable X (PopSize sample, mean = 0, SD=1)
...
rownames(XY)<- c("Subj # 1","Subj # 2","Subj # 3","Subj # 4","Subj # 5","Subj # 6","Subj # 7","Subj # 8","Subj # 9","Subj # 10","Subj # 11","Subj # 12","Subj # 13","Subj # 14","Subj # 15") # computing correlation coefficient
R<-rcorr(x,y)
# plotting the data
PP4 <- ggplot(XY, aes(x=xi, y=yi)) +
  geom_point()+
...
>>>>>>> d1f4bd3846bb5565b808bc1c053920d44a6128a5
