...
Statistical significance is at the heart of a philosophical debate [@wasserstein2016]. Should we abandon the use of p-values, should we use a more severe significance threshold or should we use an adapted one? Is the Bayes Factor better suited for science than the p-values. These questions are often hotly debated in scientific papers or on social media. Yet, the problem with p-values is that people do not understand them properly or do not understand the circumstances under which a p-value can be used. Furthermore, many people do not have a lot of insights how p-values behave in different circumstances. Here, we use our ability to randomly generate correlated or uncorrelated variables as a tool to get insights into p-values linked to correlations and many problems that have been discussed in science. This part adresses the significance problem linked to p-values.
...
Therefore, the goal of this paper is to show that simulation of artificial data can be a valid tool to understand the behavior of p-values (https://amstat.tandfonline.com/doi/abs/10.1080/00031305.2015.1081619#.XLcULeyoA0N, https://www.sciencedirect.com/science/article/pii/S1477388018300148, ), to get insights into the estimation problem and to find the best technique to account for irregularities in the data.
