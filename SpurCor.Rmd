...
Note that for `r format(PsigNDBC*100, digit=0)`% of these significant correlations, the between-groups difference for the x and y parameters was not significant. Yet, these subgroups yielded a positive correlation.
