...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,Psig), y2=c(Psig,1), t=c('a','b'))
  PP3_0 <- ggplot() +  
    ...
    geom_label(aes(x = 0.9, y = Psig/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,Psig), y2=c(Psig,1), t=c('a','b'))
  PP3_50 <- ggplot() +  
    ...
    geom_label(aes(x = 0.9, y = Psig+((1-Psig)/2), label = "False-Negative"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "black", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,Psig28), y2=c(Psig28,1), t=c('a','b'))
  PP28 <- ggplot() +  
    ...
    scale_fill_manual(values = Fcolor, 
                      ...
                      labels=c("p<=0.05", "p>0.05")) +
    geom_hline(yintercept=0.05, linetype="dashed", color = "red") +
    geom_segment(aes(x = 0.75, y = 1, xend = 0.75, yend = Psig28),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")))+
    geom_label(aes(x = 0.9, y = Psig28+((1-Psig28)/2), label = "False-Negative"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "black", 
               label.size = NA, 
...
This manipulations demonstrate how simulations can yield insights about the required sample size for detecting a correlation of a given value. The problem with power is that we rarely now in advance how big the effect size (e.g. the strengthh the correlation) will be.
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigOut), y2=c(PsigOut,1), t=c('a','b'))
  PP3Out <- ggplot() +  
    ...
    geom_label(aes(x = 0.1, y = 0.05, label = "Type 1 \nError"), 
               ...
               size = 3,
               fill = NA)+
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigOut),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigOut/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigSpear), y2=c(PsigSpear,1), t=c('a','b'))
  PP3Spear <- ggplot() +  
    ...
    geom_label(aes(x = 0.1, y = 0.05, label = "Type 1 \nError"), 
               ...
               size = 3,
               fill = NA)+
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigSpear),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigSpear/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigRob), y2=c(PsigRob,1), t=c('a','b'))
  PP3Rob <- ggplot() +  
    ...
    geom_label(aes(x = 0.1, y = 0.05, label = "Type 1 \nError"), 
               ...
               size = 3,
               fill = NA)+
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigRob),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigRob/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigSub), y2=c(PsigSub,1), t=c('a','b'))
  PP3Sub <- ggplot() +  
    ...
    scale_fill_manual(values = Fcolor, 
                      ...
                      labels=c("p<=0.05", "p>0.05")) +
    geom_hline(yintercept=0.05, linetype="dashed", color = "red") +
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigSub),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigSub/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigSubSpear), y2=c(PsigSubSpear,1), t=c('a','b'))
  PP3SubSpear <- ggplot() +  
    ...
    scale_fill_manual(values = Fcolor, 
                      ...
                      labels=c("p<=0.05", "p>0.05")) +
    geom_hline(yintercept=0.05, linetype="dashed", color = "red") +
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigSubSpear),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigSubSpear/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
...
d=data.frame(x1=c(0.33,0.33), x2=c(0.66,0.66), y1=c(0,PsigReg), y2=c(PsigReg,1), t=c('a','b'))
  PP3Reg <- ggplot() +  
    ...
    scale_fill_manual(values = Fcolor, 
                      ...
                      labels=c("p<=0.05", "p>0.05")) +
    geom_hline(yintercept=0.05, linetype="dashed", color = "red") +
    geom_segment(aes(x = 0.75, y = 0, xend = 0.75, yend = PsigReg),
     lineend = 'butt', linejoin = 'bevel',
     size = 0.5, arrow = arrow(length = unit(0.2, "inches")),colour="red")+
    geom_label(aes(x = 0.9, y = PsigReg/2, label = "False-Positive"), 
               hjust = "center", 
               vjust = "bottom", 
               colour = "red", 
               label.size = NA, 
